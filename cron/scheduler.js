...
export function startScheduler() {
  ...
  jobMatin.start();
  console.log(`Job Matin (07h00 Paris) démarré. Prochain run: ${jobMatin.nextDates().toLocaleString('fr-FR', { timeZone: 'Europe/Paris' })}`);
  jobSoir.start();
  console.log(`Job Soir (13h00 Paris) démarré. Prochain run: ${jobSoir.nextDates().toLocaleString('fr-FR', { timeZone: 'Europe/Paris' })}`);
  jobResultats.start();
  console.log(`Job Résultats (23h30 Paris) démarré. Prochain run: ${jobResultats.nextDates().toLocaleString('fr-FR', { timeZone: 'Europe/Paris' })}`);
  jobHebdo.start();
  console.log(`Job Hebdo (Dim 01h00 Paris) démarré. Prochain run: ${jobHebdo.nextDates().toLocaleString('fr-FR', { timeZone: 'Europe/Paris' })}`);
